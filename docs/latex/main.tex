...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small Optimizer and Learning Rate Study}
\rhead{\small HI 192}
\cfoot{\thepage}
...
\begin{titlepage}
  \centering
  \vspace*{4cm}
  {\LARGE\textbf{Optimizer and Learning Rate Study\\[0.4em]of Ovarian Cancer Prediction}\\[1.5em]}
  {\large HI 192: Knowledge Representation and Health Decision Support\\[1.5em]}
  {\large DelaCruz \quad Doria \quad Rodriguez\\[1em]}
  {\large May 2026}
  \vfill
\end{titlepage}
...
\subsection{Complete 84-Run Results Table}
