...
The dataset contains histopathological JPEG images of ovarian tissue, labeled as either \emph{Ovarian Cancer} or \emph{Ovarian Non-Cancer}. 
% We downloaded the data in May 2026. To respect the original authors' rights and the IEEE DataPort terms, we don't include the raw images in this repository; they have to be downloaded directly from the source.

\subsection{Class Distribution}

There are 987 images in total. As shown in Table~\ref{tab:class-composition}, the dataset is reasonably balanced.
...
\begin{table}[H]
  \centering
  \caption{Stratified train, validation, and test split.}
  \label{tab:split}
  \begin{tabular}{lrrrr}
    \toprule
    \rowcolor{tableheader}
