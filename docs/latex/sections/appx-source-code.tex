...
\lstinputlisting[style=python]{../../src/preprocessing.py}
...
\lstinputlisting[style=python]{../../src/train.py}
...
\lstinputlisting[style=python]{../../src/visualize.py}

\clearpage
\subsection*{run\_all.py}
\label{appx:src-run-all}
\codefile{src/run\_all.py}
\lstinputlisting[style=python]{../../src/run_all.py}
