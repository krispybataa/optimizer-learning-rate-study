...
\begin{table}[H]
  \centering
  \caption{Top configurations for each architecture (ranked by AUC).}
  \label{tab:best-arch}
  \begin{tabular}{llllr}
    \toprule
...
\begin{figure}[htbp]
  ...
  \caption{Accuracy across all 72 configurations.}
...
\begin{figure}[htbp]
  ...
  \caption{AUC-ROC across all 72 configurations.}
