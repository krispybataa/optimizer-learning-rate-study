...
\begin{figure}[p]
  ...
  \end{subfigure}
  \caption{Accuracy and Loss Curves: VGG19 (all 21 configurations).}
  \label{fig:acc-loss-vgg19}
\end{figure}
\clearpage
...
\begin{figure}[p]
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \caption{Nadam, LR=1e-6}
  \end{subfigure}
  \caption{Accuracy and Loss Curves: EfficientNetB3 (all 21 configurations).}
  \label{fig:acc-loss-effnet}
\end{figure}
\clearpage
...
\begin{figure}[p]
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \caption{Nadam, LR=1e-6}
  \end{subfigure}
  \caption{Accuracy and Loss Curves: ResNet50 (all 21 configurations).}
  \label{fig:acc-loss-resnet}
\end{figure}
\clearpage
...
\begin{figure}[p]
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \caption{Nadam, LR=1e-6}
  \end{subfigure}
  \caption{Accuracy and Loss Curves: DenseNet121 (all 21 configurations).}
  \label{fig:acc-loss-densenet}
\end{figure}
\clearpage
